...
namespace MvxStarter.Core.Services
{
    public interface ISearchEngine
    {
        ...
        public void FindFilesParallel(string searchPath, string fileName, int ConcurrentOperationCount, IProgress<ProgressReportModel> progress, CancellationToken cancellationToken);
    }
}
